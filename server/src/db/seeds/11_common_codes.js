exports.seed = async function (knex) {
	...
	await knex('common_code_group').insert([
		...
		{
			group_code: 'JOB_ROLE_CATEGORY',
			group_name: '직무구분',
			description: '직무 역할의 대분류',
		},
		{
			group_code: 'JOB_ROLE',
			group_name: '직무역할',
			description: '직원의 주요 직무 및 프로젝트 수행 역할',
		},
	]);
	...
	await knex('common_code').insert([
		...
		// 직무구분
		// =========================
		{ group_code: 'JOB_ROLE_CATEGORY', code: 'MANAGEMENT', code_name: '관리/리딩', sort_order: 1 },
		{ group_code: 'JOB_ROLE_CATEGORY', code: 'PLANNING_ANALYSIS', code_name: '기획/분석', sort_order: 2 },
		{ group_code: 'JOB_ROLE_CATEGORY', code: 'ARCHITECT', code_name: '아키텍트', sort_order: 3 },
		{ group_code: 'JOB_ROLE_CATEGORY', code: 'DEVELOPMENT', code_name: '개발', sort_order: 4 },
		{ group_code: 'JOB_ROLE_CATEGORY', code: 'DATA_DB', code_name: 'DB/데이터', sort_order: 5 },
		{ group_code: 'JOB_ROLE_CATEGORY', code: 'DESIGN_PUBLISHING', code_name: '디자인/퍼블리싱', sort_order: 6 },
		{ group_code: 'JOB_ROLE_CATEGORY', code: 'QA_TEST', code_name: '테스트/품질', sort_order: 7 },
		{ group_code: 'JOB_ROLE_CATEGORY', code: 'SM_OPERATION', code_name: 'SM/운영/유지보수', sort_order: 8 },
		{ group_code: 'JOB_ROLE_CATEGORY', code: 'BUSINESS', code_name: '문서/사업관리', sort_order: 9 },
		{ group_code: 'JOB_ROLE_CATEGORY', code: 'ETC', code_name: '기타', sort_order: 99 },

		// =========================
		// 관리/리딩
		// =========================
		{ group_code: 'JOB_ROLE', code: 'PM', code_name: 'PM', parent_code: 'MANAGEMENT', sort_order: 1 },
		{ group_code: 'JOB_ROLE', code: 'PL', code_name: 'PL', parent_code: 'MANAGEMENT', sort_order: 2 },
		{ group_code: 'JOB_ROLE', code: 'PMO', code_name: 'PMO', parent_code: 'MANAGEMENT', sort_order: 3 },
		...
		{
			group_code: 'JOB_ROLE',
			code: 'SERVICE_PLANNER',
			code_name: '서비스 기획자',
			parent_code: 'PLANNING_ANALYSIS',
			sort_order: 4,
		},
		{
			group_code: 'JOB_ROLE',
		...
		// 아키텍트
		// =========================
		{ group_code: 'JOB_ROLE', code: 'AA', code_name: 'AA', parent_code: 'ARCHITECT', sort_order: 7 },
		{ group_code: 'JOB_ROLE', code: 'TA', code_name: 'TA', parent_code: 'ARCHITECT', sort_order: 8 },
		{ group_code: 'JOB_ROLE', code: 'SA', code_name: 'SA', parent_code: 'ARCHITECT', sort_order: 9 },
		{ group_code: 'JOB_ROLE', code: 'DA', code_name: 'DA', parent_code: 'ARCHITECT', sort_order: 10 },
		...
		// DB/데이터
		// =========================
		{ group_code: 'JOB_ROLE', code: 'DBA', code_name: 'DBA', parent_code: 'DATA_DB', sort_order: 20 },
		{ group_code: 'JOB_ROLE', code: 'DB_DEVELOPER', code_name: 'DB 개발자', parent_code: 'DATA_DB', sort_order: 21 },
		{
			group_code: 'JOB_ROLE',
			code: 'DATA_ENGINEER',
			code_name: '데이터 엔지니어',
		...
		{ group_code: 'JOB_ROLE', code: 'BI_ANALYST', code_name: 'BI 분석가', parent_code: 'DATA_DB', sort_order: 23 },
		...
		// =========================
		{
			...
			code: 'PUBLISHER',
			code_name: '퍼블리셔',
			parent_code: 'DESIGN_PUBLISHING',
			sort_order: 24,
		},
		{
			group_code: 'JOB_ROLE',
			code: 'UI_UX_DESIGNER',
			code_name: 'UI/UX 디자이너',
			parent_code: 'DESIGN_PUBLISHING',
			sort_order: 25,
		},
		{
		...
		// 테스트/품질
		// =========================
		{ group_code: 'JOB_ROLE', code: 'QA_MANAGER', code_name: 'QA 리더', parent_code: 'QA_TEST', sort_order: 27 },
		{ group_code: 'JOB_ROLE', code: 'QA_ENGINEER', code_name: 'QA 엔지니어', parent_code: 'QA_TEST', sort_order: 28 },
		{ group_code: 'JOB_ROLE', code: 'TESTER', code_name: '테스터', parent_code: 'QA_TEST', sort_order: 29 },
		{
			group_code: 'JOB_ROLE',
			code: 'TEST_AUTOMATION_ENGINEER',
			code_name: '테스트 자동화 엔지니어',
			parent_code: 'QA_TEST',
			sort_order: 30,
		},
		...
		// =========================
		{
			...
			code: 'SM_DEVELOPER',
			code_name: 'SM 개발자',
			parent_code: 'SM_OPERATION',
			sort_order: 31,
		},
		{
			group_code: 'JOB_ROLE',
			code: 'MAINTENANCE_DEVELOPER',
			code_name: '유지보수 개발자',
			parent_code: 'SM_OPERATION',
			sort_order: 32,
		},
		{
			group_code: 'JOB_ROLE',
			code: 'APPLICATION_OPERATOR',
			code_name: '애플리케이션 운영자',
			parent_code: 'SM_OPERATION',
			sort_order: 33,
		},
		{
		...
		// 기타
		// =========================
		{ group_code: 'JOB_ROLE', code: 'ETC', code_name: '기타', parent_code: 'ETC', sort_order: 99 },
	
		// 직급
		{ group_code: 'POSITION', code: 'STAFF', code_name: '사원', sort_order: 1 },
