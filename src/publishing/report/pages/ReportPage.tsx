...
const memberSummary = [
	{ name: '김민준', dept: '개발팀', project: 'A금융 차세대', role: 'PL', rate: '100%', period: '25.03~26.09', status: '투입중' },
	{ name: '이서연', dept: '디자인', project: '벤치', role: '—', rate: '0%', period: '—', status: '벤치' },
	{ name: '박지훈', dept: '마케팅', project: 'C제조 MES', role: '개발', rate: '100%', period: '24.12~26.03', status: '투입중' },
];
		...
		<div className="p-5">
			...
			<div className="bg-card rounded-xl border overflow-hidden">
				...
				<table className="w-full text-sm">
					...
					<tbody>
						{memberSummary.map((m) => (
							<tr key={m.name} className="border-t hover:bg-muted/20 cursor-pointer transition-colors">
