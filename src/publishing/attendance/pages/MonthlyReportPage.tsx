									...
									>
										...
										<td className="py-2.5 px-3">
											<span className={`text-xs font-medium px-2 py-0.5 rounded-full ${
												m.status === '승인' ? 'bg-emerald-100 text-emerald-700 dark:bg-emerald-900/30 dark:text-emerald-300' :
												m.status === '제출' ? 'bg-sky-100 text-sky-700 dark:bg-sky-900/30 dark:text-sky-300' :
