...
**react-app-peoplify**는 `react-app-scaffold` 기반 프로젝트 구조를 따른다. 워크스페이스 구조는 다음과 같다. 또한 react-app-peoplify 애플리케이션 개발을 위한 SI를 시작한다고 가정한다.
...
```
* 실제 프로젝트 참조 URL : 
* react-app-peoplify 프로젝트를 위한 기획 참조 : /plan/react-app-peoplify-proposal.pptx, /plan/react-app-peoplify-ui.pptx
